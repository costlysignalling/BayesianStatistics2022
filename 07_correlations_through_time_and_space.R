...
plot( d.tools$P, d.tools$T , xlab="log population (std)", ylab="total tools" ,
...
m.OU <- ulam(
  alist(
    B ~ multi_normal( mu , SIGMA ),
    mu <- a + bM*M + bG*G,
    #TASK 19: Fill this line with the function that computes expecetd covariance based on parameters of exponential (GPL1) kernel.
    #HINT: The pest parallel so far is in model m.distance of the previous problem
    #If you struggle, you can find the solution in TASK_SOLUTIONS.R line 399
